...
export default function DashboardsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7] font-sans dark:bg-neutral-950">
      <div className="mx-auto max-w-4xl px-6 py-12 sm:px-8 lg:px-12">
        <div className="mb-12 flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 rounded-lg border border-solid border-neutral-900 bg-transparent px-5 py-2.5 text-sm font-medium transition-colors hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-900"
          >
            Back to Home
